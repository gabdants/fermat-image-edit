...
export class FonteService {
  ...
  postFonte(file: File){
    ...
    return this.http.post<any>(`http://34.220.136.85:8181/font/uploadFont`, formData, {
      headers,
  ...
  updateFontFile(){
    ...
    return this.http.get<any>(`http://34.220.136.85:8181/font/getCss`, {headers});
  }
  ...
  getFonts(){
    ...
    return this.http.get<any>(`http://34.220.136.85:8181/font/getFonts`, {headers});
  }
