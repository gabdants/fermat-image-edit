...
export class FonteService {
  ...
  postFonte(file: File){
    ...
    return this.http.post<any>(`http://52.27.128.99:8181/font/uploadFont`, formData, {
      headers,
  ...
  updateFontFile(){
    ...
    return this.http.get<any>(`http://52.27.128.99:8181/font/getCss`, {headers});
  }
  ...
  getFonts(){
    ...
    return this.http.get<any>(`http://52.27.128.99:8181/font/getFonts`, {headers});
  }
